...
```
alonhadat <command> [arguments] [flags]
```

Run `alonhadat <command> --help` for the full flag list on any command. This
...
per operation you declare in `alonhadat/domain.go`.
