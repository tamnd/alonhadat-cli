...
Most of these come down to network reality or how alonhadat serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

alonhadat rate-limits like any public site. alonhadat already paces
...
Where a surface is gated, alonhadat reads a cookie or token you supply
...
`alonhadat`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what alonhadat actually did
